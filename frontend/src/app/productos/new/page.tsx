...
import { ArrowLeft, Package, DollarSign, Archive, Sparkles, Save, X, AlertCircle } from 'lucide-react';
              ...
              <div className="flex flex-col lg:flex-row lg:items-center gap-6 mb-12">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-lg">
                    Agrega un nuevo accesorio a tu colección elegante
                  </p>
                </div>
              </div>
            </div>
              ...
              {isLoading && (
                <div className="mt-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl">
                  <div className="flex items-center space-x-3 text-green-700 dark:text-green-400">
                    ...
                    <span>Creando tu producto... ¡Casi listo! ✨</span>
                  </div>
                </div>
              )}
            </div>
